  ...
  const features = [
    {
      ...
      description:
        "End-to-end encryption, PCI DSS compliance, and advanced fraud protection keep your transactions secure.",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      title: "Global Reach",
      description:
        "Accept payments from customers worldwide with support for 180+ countries and 135+ currencies.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Get instant insights into your payment performance with comprehensive dashboards and reporting.",
    },
    {
      icon: (
        <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            features you need to grow your business.
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-[#172D55]/5 to-[#D2B253]/5 rounded-3xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses that trust Legacy Payments for their
