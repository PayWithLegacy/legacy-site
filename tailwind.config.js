...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'brand': '0 10px 25px -3px rgba(37, 99, 235, 0.1), 0 4px 6px -2px rgba(37, 99, 235, 0.05)',
        'brand-lg': '0 25px 50px -12px rgba(37, 99, 235, 0.25)',
      },
      backgroundImage: {
        'gradient-brand': 'linear-gradient(135deg, #2563eb 0%, #4f46e5 100%)',
        'gradient-brand-light': 'linear-gradient(135deg, #3b82f6 0%, #6366f1 100%)',
      },
    },
  },
  plugins: [],
